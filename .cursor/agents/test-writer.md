---
name: test-writer
description: Writes or updates tests for an assigned work package, verifying contract acceptance criteria. Use when tests need to be written against a pre-defined feature contract, after implementation is complete or alongside it.
model: default
---
