...
FEATURES: list[dict] = [
    ...
    # --- Milestone 16: Modulation & Automation Test Coverage ---
    {
        ...
        "id": "16-01",
        "title": "Stacked LFO modulation test",
        "parent": "US-16-01-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: two LFOs modulating the same SubtractiveSynth produce complex spectral variation beyond single-LFO.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["Two LFOs on different params produce HF energy variation > 2x across windows",
                   "Two LFOs on same param produce additive spectral variation",
                   "Removing one LFO decreases spectral variation"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-02",
        "title": "Effect device modulation test",
        "parent": "US-16-02-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: LFO modulating parameters on Compressor/Gate/Expander/Limiter produce audible dynamics changes.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["LFO on Compressor threshold produces RMS variation across windows",
                   "LFO on Gate threshold produces amplitude modulation",
                   "LFO on Gate range produces partial gating variation",
                   "LFO on Expander threshold produces amplitude variation",
                   "LFO on Limiter ceiling produces peak variation"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-03",
        "title": "Common parameter gain/pan modulation test",
        "parent": "US-16-03-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: LFO modulating gain and pan common parameters produces audible amplitude/stereo variation.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["LFO on gain produces RMS variation across windows",
                   "LFO on pan produces RMS deviation from unmodulated baseline",
                   "Two LFOs on gain + pan simultaneously produce complex variation"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-04",
        "title": "Percussion generator modulation test",
        "parent": "US-16-04-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: LFO modulating parameters on Kick/Snare/Clap/Crash/Cymbal generators changes timbre.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["LFO on Kick pitch produces RMS change vs unmodulated",
                   "LFO on Snare body produces RMS change",
                   "LFO on Clap tone produces RMS change",
                   "LFO on Crash spread produces RMS change",
                   "LFO on Cymbal width produces RMS change"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-05",
        "title": "ADSR envelope modulator test",
        "parent": "US-16-05-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: ADSR/ADR envelope modulators produce characteristic attack-sustain-decay shapes on filter cutoff.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["ADSR envelope shows HF energy peak during attack, lower in sustain",
                   "ADR (no sustain) decays faster than ADSR",
                   "Zero-attack ADSR produces immediate HF peak"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-06",
        "title": "LFO polarity test",
        "parent": "US-16-06-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: bipolar/positive/negative LFO polarity produces measurably different spectral content.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["Bipolar LFO produces full HF sweep (ratio > 1.5x)",
                   "Positive-only LFO produces different HF pattern than bipolar",
                   "Negative-only LFO produces different HF pattern than positive",
                   "Polarity field persists in JSON round-trip"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-07",
        "title": "LFO sync-to-BPM test",
        "parent": "US-16-07-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: LFO syncDivision synchronizes to project BPM, producing correct cycle counts.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["Sync 1/4 LFO at 120 BPM produces ~4 modulation cycles in 4 beats",
                   "Sync 1/2 LFO produces ~2 cycles in 4 beats",
                   "Sync and free LFO produce different cycle counts",
                   "BPM change affects sync LFO rate but not free LFO rate"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-08",
        "title": "Combined gain/pan modulation and automation test",
        "parent": "US-16-08-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: combined modulation and automation on gain/pan combine additively without conflict.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["Auto-only gain ramp produces monotonically increasing RMS",
                   "Mod-only gain produces periodic RMS variation",
                   "Combined mod+auto shows both ramp trend and ripple",
                   "Combined mod+auto on pan does not crash or clip"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-09",
        "title": "Effect device automation test",
        "parent": "US-16-09-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Engine test: automation clips on Compressor/Gate/Expander/Limiter produce dynamic processing changes.",
            "layout": "N/A — engine test only",
            "states": [],
            "copy": [],
            "ac": ["Compressor threshold automation produces louder output late in ramp",
                   "Gate threshold automation opens gate over time",
                   "Expander threshold automation activates expansion",
                   "Limiter ceiling automation allows increasing peaks"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-10",
        "title": "Flutter LFO bridge CRUD test",
        "parent": "US-16-10-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Flutter test: EngineBridge LFO/modulation methods dispatch correctly through MethodChannel.",
            "layout": "N/A — Flutter unit test",
            "states": [],
            "copy": [],
            "ac": ["createLfo returns snapshot with new LFO",
                   "removeLfo returns snapshot without LFO",
                   "updateLfoParam updates rate/waveform on snapshot",
                   "assignModulation adds edge to snapshot",
                   "removeModulation removes edge from snapshot",
                   "createLfo with modulatorType 0/1/2 returns correct types"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-11",
        "title": "Flutter modulation widget test",
        "parent": "US-16-11-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Flutter test: ModulationGrid, ModulationStrip, LfoPropertiesPanel, ModulatableSpinnerShell render correctly.",
            "layout": "N/A — Flutter widget test",
            "states": [],
            "copy": [],
            "ac": ["ModulationGrid renders correct number of LFO tiles",
                   "ModulationGrid add tile present when slots available",
                   "ModulationStrip displays LFO cards with controls",
                   "ModulationStrip shows Add Modulator button",
                   "LfoPropertiesPanel shows waveform dropdown and rate slider",
                   "LfoPropertiesPanel shows target edges",
                   "ModulatableSpinnerShell shows modulation bar when active",
                   "ModulatableSpinnerShell shows connect-mode pulse"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-12",
        "title": "Flutter LFO snapshot JSON parsing test",
        "parent": "US-16-12-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Flutter test: LfoSnapshot/ModulationEdgeSnapshot/ProjectSnapshot JSON parsing with edge cases.",
            "layout": "N/A — Flutter unit test",
            "states": [],
            "copy": [],
            "ac": ["LfoSnapshot.fromMap parses all 13 fields",
                   "LfoSnapshot.fromMap handles missing fields with defaults",
                   "ModulationEdgeSnapshot.fromMap parses all 4 fields",
                   "ModulationEdgeSnapshot.fromMap handles missing fields",
                   "ProjectSnapshot.fromMap parses lfos and modEdges arrays",
                   "Edge cases: null values, negative amounts, zero IDs"],
        },
        "ix": {
            "entry": [],
            "map": [],
    ...
    },
    {
        "milestone": "milestone-16",
        "id": "16-13",
        "title": "Flutter modulation persistence test",
        "parent": "US-16-13-modulation-test-coverage.md",
        "status": "Done",
        "ux": {
            "intent": "Flutter test: save/load project with LFOs and modulation edges preserves data through bridge.",
            "layout": "N/A — Flutter unit test",
            "states": [],
            "copy": [],
            "ac": ["LFO + modEdge persist through save/load",
                   "Multiple LFOs + edges survive save/load",
                   "Removing LFO before save means absent after load",
                   "Removing edge before save means absent after load"],
        },
        "ix": {
            "entry": [],
            "map": [],
