...
std::span<const ParamDescriptor> StutterDeviceType::paramDescriptors() const noexcept {
    static constexpr ParamDescriptor kParams[] = {
        ...
        {static_cast<uint16_t>(StutterParam::RateSync), "rateSync", "Sync", 1.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(StutterParam::Direction), "direction", "Direction", 0.0f, 0.0f, 4.0f, true, true, ParameterUpdateRate::Discrete},
