...
std::span<const ParamDescriptor> BitcrusherDeviceType::paramDescriptors() const noexcept {
    static constexpr ParamDescriptor kParams[] = {
        ...
        {static_cast<uint16_t>(BitcrusherParam::Mode), "bcMode", "Mode", 0.0f, 0.0f, 3.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(BitcrusherParam::Shape), "bcShape", "Shape", 0.0f, 0.0f, 3.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(BitcrusherParam::DitherMode), "bcDitherMode", "Dither Mode", 0.0f, 0.0f, 3.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(BitcrusherParam::DitherAmount), "bcDitherAmount", "Dither", 0.0f, 0.0f, 1.0f, true, true},
        {static_cast<uint16_t>(BitcrusherParam::ClipMode), "bcClipMode", "Clip Mode", 0.0f, 0.0f, 2.0f, true, true, ParameterUpdateRate::Discrete},
