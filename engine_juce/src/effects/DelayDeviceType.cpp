...
std::span<const ParamDescriptor> DelayDeviceType::paramDescriptors() const noexcept {
    static constexpr ParamDescriptor kParams[] = {
        ...
        {static_cast<uint16_t>(DelayParam::TimeMode), "timeMode", "Time Mode", 0.0f, 0.0f, 3.0f, true, false},
        {static_cast<uint16_t>(DelayParam::NoteCount), "noteCount", "Notes", 1.0f, 1.0f, 8.0f, true, false},
        {static_cast<uint16_t>(DelayParam::BlurMode), "blurMode", "Blur", 0.0f, 0.0f, 2.0f, true, false},
