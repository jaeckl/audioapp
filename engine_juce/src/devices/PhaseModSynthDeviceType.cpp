...
std::span<const ParamDescriptor> PhaseModSynthDeviceType::paramDescriptors() const noexcept {
    static constexpr ParamDescriptor kParams[] = {
        ...
        {static_cast<uint16_t>(PhaseModSynthParam::Op1Wave), "pmOp1Wave", "Op1 Wave", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(PhaseModSynthParam::Op2Wave), "pmOp2Wave", "Op2 Wave", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(PhaseModSynthParam::Op3Wave), "pmOp3Wave", "Op3 Wave", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(PhaseModSynthParam::Op4Wave), "pmOp4Wave", "Op4 Wave", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(PhaseModSynthParam::FilterMode), "filterMode", "Filter Mode", 0.0f, 0.0f, 5.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(PhaseModSynthParam::AlgoIndex), "pmAlgoIndex", "Algorithm", 0.0f, 0.0f, 7.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(PhaseModSynthParam::UnisonVoices), "pmUnisonVoices", "Unison Voices", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(PhaseModSynthParam::Mono), "pmMono", "Mono", 0.0f, 0.0f, 1.0f, true, false, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(PhaseModSynthParam::Legato), "pmLegato", "Legato", 0.0f, 0.0f, 1.0f, true, false, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(PhaseModSynthParam::LfoShape), "pmLfoShape", "LFO Shape", 0.0f, 0.0f, 4.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(PhaseModSynthParam::LfoDest), "pmLfoDest", "LFO Dest", 0.0f, 0.0f, 4.0f, true, true, ParameterUpdateRate::Discrete},
    };
    return kParams;
}
