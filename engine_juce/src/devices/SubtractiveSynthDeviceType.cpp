...
std::span<const ParamDescriptor> SubtractiveSynthDeviceType::paramDescriptors() const noexcept {
    static constexpr ParamDescriptor kParams[] = {
        ...
        {static_cast<uint16_t>(SubtractiveParam::FilterMode), "filterMode", "Filter Mode", 0.0f, 0.0f, 5.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(SubtractiveParam::Osc1Octave), "osc1Octave", "Osc1 Octave", 0.5f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::Osc1Semi), "osc1Semi", "Osc1 Semi", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::Osc1Detune), "osc1Detune", "Osc1 Detune", 0.5f, 0.0f, 1.0f, true, true},
        {static_cast<uint16_t>(SubtractiveParam::Osc2Octave), "osc2Octave", "Osc2 Octave", 0.5f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::Osc2Semi), "osc2Semi", "Osc2 Semi", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(SubtractiveParam::OscMixMode), "oscMixMode", "Osc Mix Mode", 0.0f, 0.0f, 4.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::Osc1Sync), "osc1Sync", "Osc1 Sync", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::Osc2Sync), "osc2Sync", "Osc2 Sync", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::NoiseLevel), "noiseLevel", "Noise Level", 0.0f, 0.0f, 1.0f, true, true},
        {static_cast<uint16_t>(SubtractiveParam::UnisonVoices), "unisonVoices", "Unison Voices", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        ...
        {static_cast<uint16_t>(SubtractiveParam::FilterShaperMode), "filterShaperMode", "Filter Shaper Mode", 1.0f, 0.0f, 3.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::SynthLegato), "synthLegato", "Legato", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
        {static_cast<uint16_t>(SubtractiveParam::SynthMono), "synthMono", "Mono", 0.0f, 0.0f, 1.0f, true, true, ParameterUpdateRate::Discrete},
    };
    return kParams;
}
