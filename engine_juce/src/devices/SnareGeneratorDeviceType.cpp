...
std::vector<std::string_view> SnareGeneratorDeviceType::modulatableParams() const {
    return {"gain", "snareBody", "snareRing", "snareTune", "snareSnares",
...
std::span<const ParamDescriptor> SnareGeneratorDeviceType::paramDescriptors() const noexcept {
    static constexpr ParamDescriptor kParams[] = {
        {static_cast<uint16_t>(SnareParam::Model), "snareModel", "Model", 0.0f, 0.0f, 1.0f, false, false, ParameterUpdateRate::Discrete},
