...
void applyAutomationValue(DeviceVariantParams& params,
    ...
    case ParamKind::WavetableSynth:
        if (auto* p = std::get_if<WavetableSynthParamsPlayback>(&params)) {
            ...
            case WavetableParam::WtSubLevel:      p->wtSubLevel = value; break;
            case WavetableParam::WtSubOctave:     p->wtSubOctave = std::clamp(static_cast<int>(std::lround(value)), 0, 2); break;
            case WavetableParam::WtNoiseLevel:    p->wtNoiseLevel = value; break;
            case WavetableParam::WtNoiseColor:    p->wtNoiseColor = value; break;
            case WavetableParam::WtWarp:          p->wtWarp = value; break;
            case WavetableParam::WtWarpMode:      p->wtWarpMode = std::clamp(static_cast<int>(std::lround(value)), 0, 4); break;
            case WavetableParam::WtPhase:         p->wtPhase = value; break;
            case WavetableParam::WtPhaseRandom:   p->wtPhaseRandom = value; break;
            case WavetableParam::WtSubShape:      p->wtSubShape = std::clamp(static_cast<int>(std::lround(value)), 0, 2); break;
            case WavetableParam::FilterDrive:     p->filterDrive = value; break;
            case WavetableParam::WtFeedback:      p->wtFeedback = value; break;
            case WavetableParam::WtStereoSpread:  p->wtStereoSpread = value; break;
            case WavetableParam::WtGlide:         p->wtGlide = value; break;
            case WavetableParam::FilterMode:      p->filterMode = std::clamp(static_cast<int>(std::lround(value)), 0, 3); break;
