...
inline constexpr const char* kSpectralLoudSplit = "spectral_loud_split";
...
inline bool isSpectralLoudSplitType(std::string_view typeId) {
    return typeId == kSpectralLoudSplit;
}
