    ...
    void runTest() override
    {
        ...
        beginTest("parameter set and round-trip");
        {
            ...
            expectWithinAbsoluteError(
                std::get<audioapp::OscillatorParams>(oscillator.config.instance).frequencyHz,
                880.0f, 0.001f);
        ...
        beginTest("sampler parameter");
        {
            ...
            const auto& samplerInst = std::get<audioapp::SamplerModel>(sampler.config.instance);
        ...
        beginTest("subtractive synth parameters");
        {
            ...
            const auto& synthInst = std::get<audioapp::SubtractiveSynthParams>(synth.config.instance);
            ...
            expectWithinAbsoluteError(
                std::get<audioapp::SubtractiveSynthParams>(synth.config.instance).osc1Shape,
                0.75f, 0.001f);
        }
        ...
        beginTest("slot var round-trip");
        {
            ...
            expectWithinAbsoluteError(
                std::get<audioapp::OscillatorParams>(roundTripSlot.config.instance).frequencyHz,
                880.0f, 0.001f);
        }
    }
};
