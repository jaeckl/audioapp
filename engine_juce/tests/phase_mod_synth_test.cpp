...
public:
    ...
    void runTest() override {
        ...
        beginTest("B1: DefaultInstance");
        {
            ...
            const bool isPM = std::holds_alternative<audioapp::PhaseModSynthInstance>(slot.instance);
            expect(isPM, "Slot instance should be PhaseModSynthInstance");

            const auto& inst = std::get<audioapp::PhaseModSynthInstance>(slot.instance);
        ...
        beginTest("B2: ToSnapshotRoundtrip");
        {
            ...
            {
                auto& inst = std::get<audioapp::PhaseModSynthInstance>(slot.instance);
            ...
            const bool isPM = std::holds_alternative<audioapp::PhaseModSynthInstance>(restored.instance);
            expect(isPM, "Restored slot should be PhaseModSynthInstance");

            const auto& inst = std::get<audioapp::PhaseModSynthInstance>(restored.instance);
        ...
        beginTest("B9: DeviceRegistryIntegration");
        {
            ...
            const bool isPM = std::holds_alternative<audioapp::PhaseModSynthInstance>(slot.instance);
            expect(isPM, "Registry-created slot should be PhaseModSynthInstance");
