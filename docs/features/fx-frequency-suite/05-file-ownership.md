...
| `engine_juce/include/audioapp/devices/DeviceSlot.hpp` | WP-5 | Add FrequencyFxInstance.hpp include + variant entry | |
...
| `app_flutter/lib/bridge/project_snapshot.dart` | WP-7 | Add ffx* fields to DeviceSnapshot, fromMap parsing | |
| `app_flutter/lib/features/device_strip/device_strip_slot.dart` | WP-7 | Add switch cases, imports | |
| `app_flutter/lib/features/device_strip/device_strip_chrome.dart` | WP-7 | Add types to `_dynamicsTypes` set | |
...
| `app_flutter/lib/features/device_strip/device_strip_theme.dart` | WP-7 | Add accent colors, labels | |
| `app_flutter/lib/features/device_strip/device_container_tabs.dart` | WP-7 | Add entries (empty tabs) | |
| `app_flutter/lib/features/device_strip/device_picker_sheet.dart` | WP-7 | Add "Frequency Effects" section with 3 devices | |