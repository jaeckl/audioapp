...
As a **user**, I want **bridge play/stop commands** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Bridge play/stop commands** as a complete vertical slice — demoable once on Android without follow-up fixes (M01).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-01-05
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **bridge play/stop commands** applies.
...
- End-to-end wiring for **Bridge play/stop commands** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **bridge play/stop commands** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **bridge play/stop commands** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-01-05-ux-ui.md)
- [Interaction](US-01-05-interaction.md)
