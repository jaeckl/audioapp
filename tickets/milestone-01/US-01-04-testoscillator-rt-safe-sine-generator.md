...
As a **user**, I want **testoscillator rt-safe sine generator** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **TestOscillator RT-safe sine generator** as a complete vertical slice — demoable once on Android without follow-up fixes (M01).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-01-04
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **testoscillator rt-safe sine generator** applies.
...
- End-to-end wiring for **TestOscillator RT-safe sine generator** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **testoscillator rt-safe sine generator** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **testoscillator rt-safe sine generator** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-01-04-ux-ui.md)
- [Interaction](US-01-04-interaction.md)
