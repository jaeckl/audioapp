...
As a **user**, I want **master gain parameter & soft clip** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Master gain parameter & soft clip** as a complete vertical slice — demoable once on Android without follow-up fixes (M01).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-01-07
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **master gain parameter & soft clip** applies.
...
- End-to-end wiring for **Master gain parameter & soft clip** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **master gain parameter & soft clip** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **master gain parameter & soft clip** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-01-07-ux-ui.md)
- [Interaction](US-01-07-interaction.md)
