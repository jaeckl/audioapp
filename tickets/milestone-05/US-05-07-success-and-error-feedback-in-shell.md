...
As a **user**, I want **success & error feedback in shell** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Success & error feedback in shell** as a complete vertical slice — demoable once on Android without follow-up fixes (M05).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-05-07
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **success & error feedback in shell** applies.
...
- End-to-end wiring for **Success & error feedback in shell** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **success & error feedback in shell** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **success & error feedback in shell** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-05-07-ux-ui.md)
- [Interaction](US-05-07-interaction.md)
