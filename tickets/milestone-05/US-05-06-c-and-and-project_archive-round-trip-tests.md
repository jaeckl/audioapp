...
As a **developer/PO**, I want **c++ project_archive round-trip tests** so the product stays shippable and verifiable on device.

## Goal

Ship **C++ project_archive round-trip tests** as a complete vertical slice — demoable once on Android without follow-up fixes (M05).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-05-06
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **c++ project_archive round-trip tests** applies.
...
- End-to-end wiring for **C++ project_archive round-trip tests** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **c++ project_archive round-trip tests** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **c++ project_archive round-trip tests** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-05-06-ux-ui.md)
- [Interaction](US-05-06-interaction.md)
