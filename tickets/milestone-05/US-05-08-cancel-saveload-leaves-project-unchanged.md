# US-05-08: Cancel save/load leaves project unchanged
...
As a **user**, I want **cancel save/load leaves project unchanged** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Cancel save/load leaves project unchanged** as a complete vertical slice — demoable once on Android without follow-up fixes (M05).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-05-08
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **cancel save/load leaves project unchanged** applies.
...
- End-to-end wiring for **Cancel save/load leaves project unchanged** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **cancel save/load leaves project unchanged** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **cancel save/load leaves project unchanged** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-05-08-ux-ui.md)
- [Interaction](US-05-08-interaction.md)
