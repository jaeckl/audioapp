# US-02-07: Selected track highlight in arrangement
...
As a **user**, I want **selected track highlight in arrangement** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Selected track highlight in arrangement** as a complete vertical slice — demoable once on Android without follow-up fixes (M02).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-02-07
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **selected track highlight in arrangement** applies.
...
- End-to-end wiring for **Selected track highlight in arrangement** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **selected track highlight in arrangement** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **selected track highlight in arrangement** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-02-07-ux-ui.md)
- [Interaction](US-02-07-interaction.md)
