...
As a **user**, I want **device & track ids in project model** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Device & track IDs in project model** as a complete vertical slice — demoable once on Android without follow-up fixes (M02).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-02-04
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **device & track ids in project model** applies.
...
- End-to-end wiring for **Device & track IDs in project model** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **device & track ids in project model** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **device & track ids in project model** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-02-04-ux-ui.md)
- [Interaction](US-02-04-interaction.md)
