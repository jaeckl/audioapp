...
As a **user**, I want **track row in arrangement view** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Track row in arrangement view** as a complete vertical slice — demoable once on Android without follow-up fixes (M02).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-02-06
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **track row in arrangement view** applies.
...
- End-to-end wiring for **Track row in arrangement view** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **track row in arrangement view** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **track row in arrangement view** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-02-06-ux-ui.md)
- [Interaction](US-02-06-interaction.md)
