# US-04-06: Close piano roll returns to arrangement
...
As a **user**, I want **close piano roll returns to arrangement** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Close piano roll returns to arrangement** as a complete vertical slice — demoable once on Android without follow-up fixes (M04).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-04-06
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **close piano roll returns to arrangement** applies.
...
- End-to-end wiring for **Close piano roll returns to arrangement** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **close piano roll returns to arrangement** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **close piano roll returns to arrangement** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-04-06-ux-ui.md)
- [Interaction](US-04-06-interaction.md)
