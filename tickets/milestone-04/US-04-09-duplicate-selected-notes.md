...
As a **user**, I want **duplicate selected notes** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Duplicate selected notes** as a complete vertical slice — demoable once on Android without follow-up fixes (M04).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-04-09
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **duplicate selected notes** applies.
...
- End-to-end wiring for **Duplicate selected notes** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **duplicate selected notes** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **duplicate selected notes** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-04-09-ux-ui.md)
- [Interaction](US-04-09-interaction.md)
