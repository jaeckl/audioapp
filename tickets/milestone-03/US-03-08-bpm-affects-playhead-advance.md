...
As a **user**, I want **bpm affects playhead advance** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **BPM affects playhead advance** as a complete vertical slice — demoable once on Android without follow-up fixes (M03).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-03-08
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **bpm affects playhead advance** applies.
...
- End-to-end wiring for **BPM affects playhead advance** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **bpm affects playhead advance** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **bpm affects playhead advance** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-03-08-ux-ui.md)
- [Interaction](US-03-08-interaction.md)
