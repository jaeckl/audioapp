...
As a **user**, I want **seed note in new midi clip** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Seed note in new MIDI clip** as a complete vertical slice — demoable once on Android without follow-up fixes (M03).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-03-05
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **seed note in new midi clip** applies.
...
- End-to-end wiring for **Seed note in new MIDI clip** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **seed note in new midi clip** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **seed note in new midi clip** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-03-05-ux-ui.md)
- [Interaction](US-03-05-interaction.md)
