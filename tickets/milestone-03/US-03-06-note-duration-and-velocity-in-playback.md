...
As a **user**, I want **note duration & velocity in playback** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Note duration & velocity in playback** as a complete vertical slice — demoable once on Android without follow-up fixes (M03).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-03-06
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **note duration & velocity in playback** applies.
...
- End-to-end wiring for **Note duration & velocity in playback** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **note duration & velocity in playback** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **note duration & velocity in playback** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-03-06-ux-ui.md)
- [Interaction](US-03-06-interaction.md)
