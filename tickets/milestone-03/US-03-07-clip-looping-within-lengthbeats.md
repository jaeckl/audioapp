...
As a **user**, I want **clip looping within lengthbeats** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Clip looping within lengthBeats** as a complete vertical slice — demoable once on Android without follow-up fixes (M03).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-03-07
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **clip looping within lengthbeats** applies.
...
- End-to-end wiring for **Clip looping within lengthBeats** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **clip looping within lengthbeats** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **clip looping within lengthbeats** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-03-07-ux-ui.md)
- [Interaction](US-03-07-interaction.md)
