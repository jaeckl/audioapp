...
As a **developer/PO**, I want **c++ midi_clip_playback_test** so the product stays shippable and verifiable on device.

## Goal

Ship **C++ midi_clip_playback_test** as a complete vertical slice — demoable once on Android without follow-up fixes (M03).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-03-09
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **c++ midi_clip_playback_test** applies.
...
- End-to-end wiring for **C++ midi_clip_playback_test** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **c++ midi_clip_playback_test** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **c++ midi_clip_playback_test** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-03-09-ux-ui.md)
- [Interaction](US-03-09-interaction.md)
