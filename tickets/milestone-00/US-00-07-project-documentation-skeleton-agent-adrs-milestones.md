# US-00-07: Project documentation skeleton (AGENT, ADRs, milestones)
...
As a **user**, I want **project documentation skeleton (agent, adrs, milestones)** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Project documentation skeleton (AGENT, ADRs, milestones)** as a complete vertical slice — demoable once on Android without follow-up fixes (M00).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-00-07
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **project documentation skeleton (agent, adrs, milestones)** applies.
...
- End-to-end wiring for **Project documentation skeleton (AGENT, ADRs, milestones)** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **project documentation skeleton (agent, adrs, milestones)** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **project documentation skeleton (agent, adrs, milestones)** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-00-07-ux-ui.md)
- [Interaction](US-00-07-interaction.md)
