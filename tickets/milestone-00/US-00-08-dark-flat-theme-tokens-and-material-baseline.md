...
As a **user**, I want **dark flat theme tokens & material baseline** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Dark flat theme tokens & Material baseline** as a complete vertical slice — demoable once on Android without follow-up fixes (M00).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-00-08
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **dark flat theme tokens & material baseline** applies.
...
- End-to-end wiring for **Dark flat theme tokens & Material baseline** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **dark flat theme tokens & material baseline** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **dark flat theme tokens & material baseline** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-00-08-ux-ui.md)
- [Interaction](US-00-08-interaction.md)
