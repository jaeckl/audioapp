...
As a **user**, I want **flutter ↔ native methodchannel bridge scaffold** so my workflow on phone feels like a real DAW, not a demo.

## Goal

Ship **Flutter ↔ native MethodChannel bridge scaffold** as a complete vertical slice — demoable once on Android without follow-up fixes (M00).

## Background

- [roadmap.md](../../docs/milestones/roadmap.md) — US-00-04
- [AGENT.md](../../AGENT.md) §2.5–2.7 — vertical slice, JUCE JSON, system dialogs
- Relevant architecture docs under `docs/architecture/`

## UX flow

1. User opens the DAW and reaches the surface where **flutter ↔ native methodchannel bridge scaffold** applies.
...
- End-to-end wiring for **Flutter ↔ native MethodChannel bridge scaffold** (Flutter → bridge → C++ engine where applicable)
...
1. Launch app → exercise **flutter ↔ native methodchannel bridge scaffold** per UX flow above.\n2. Verify success feedback and persistence if applicable.
...
User can **flutter ↔ native methodchannel bridge scaffold** with immediate feedback — the milestone “wow moment” for this slice.
...
- [UX/UI](US-00-04-ux-ui.md)
- [Interaction](US-00-04-interaction.md)
