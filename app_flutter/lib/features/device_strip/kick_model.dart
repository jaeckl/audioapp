/// Kick engine model selection (`kickModel` param 0…1 → discrete index).
abstract final class KickModel {
  static const labels = ['808', '909', 'Analog'];
