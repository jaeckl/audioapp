/// Cymbal (hi-hat) model selection (`cymbalModel` param 0…1 → discrete index).
abstract final class CymbalModel {
  static const labels = ['Closed', 'Open', 'Pedal'];
