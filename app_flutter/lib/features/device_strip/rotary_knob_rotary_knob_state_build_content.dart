...
Widget _buildContent(BuildContext context) {
    ...
    final pulseAccent = widget.linkModeActive ? widget.linkModeAccent : widget.accentColor;
    final showConnectPulse = (widget.connectModeActive || widget.linkModeActive) && _highlightsVisible;
    final effectivePolarity = widget.polarityParamId != null && widget.deviceId != null
        ? modulatorPolarityForParam(
            paramId: widget.polarityParamId!,
            deviceId: widget.deviceId!,
            modEdges: widget.modEdges,
            lfos: widget.lfos,
            connectModeLfoId: widget.connectModeActive ? widget.connectModeLfoId : null,
          )
              ...
              child: SizedBox(
                ...
                child: FittedBox(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(Icons.chevron_left, size: 10, color: Colors.white54),
                      Text(
                        widget.label,
                        style: theme.textTheme.labelSmall?.copyWith(
                      ...
                      const Icon(Icons.chevron_right, size: 10, color: Colors.white54),
                    ],
                  ),
                ),
              ),
